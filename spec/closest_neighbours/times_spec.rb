...
RSpec.describe ClosestNeighbours::Times do
  describe '#call' do
    ...
    it { expect { described_class.new('0', []).call }.to raise_error ClosestNeighbours::NonIntegerGroupsError }
    ...
    it { expect(described_class.new(3, [1, 2, 20, 25, 30]).call).to eq [[1, 2], [20, 25], [30]] }
